...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-dark-bg transition-colors duration-300">
      {/* Top Navbar */}
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-dark-card/95 backdrop-blur-xs border-b border-black/6 dark:border-white/6 shadow-nav">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <NavLink to="/" className="flex items-center gap-2.5 group">
              <img src="/logo.png" alt="İstanbul Bekliyor" className="w-9 h-9 rounded-lg shadow-xs group-hover:shadow-md transition-shadow" />
                  ...
                  className={({ isActive }) =>
                    `px-3 py-2 text-[13px] font-medium rounded-lg transition-all duration-200 ${
                      isActive
                        ...
                        : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100/60 dark:hover:bg-white/6'
                    }`
                  }
                >
                  {item.label}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-red/6 border border-brand-red/10">
              ...
              <button
                ...
                className="md:hidden p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/6 transition-colors"
              >
        ...
        {/* Mobile Nav Dropdown */}
        {mobileOpen && (
          <div className="md:hidden border-t border-black/4 dark:border-white/4 bg-white dark:bg-dark-card animate-slide-up">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block px-3 py-2.5 text-sm font-medium rounded-lg transition-all ${
                      isActive
                        ? 'text-brand-red bg-brand-red/6'
                        : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-white/4'
                    }`
                  }
                >
                  {item.label}
      ...
      {/* Footer */}
      <footer className="border-t border-black/4 dark:border-white/4 bg-white dark:bg-dark-card mt-12 transition-colors">
